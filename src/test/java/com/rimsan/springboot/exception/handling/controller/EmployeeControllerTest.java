package com.rimsan.springboot.exception.handling.controller;
...
import com.rimsan.springboot.exception.handling.application.SBCustomExceptionHandlingMicroServiceApplication;
import com.rimsan.springboot.exception.handling.controller.EmployeeController;
...
import com.rimsan.springboot.exception.handling.repo.EmployeeRepository;
import com.rimsan.springboot.exception.handling.serviceImpl.EmployeeServiceImpl;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = SBCustomExceptionHandlingMicroServiceApplication.class)
